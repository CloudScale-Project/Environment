...
import eu.cloudscaleproject.env.csm.properties.components.ProvidedInterfaceComposite;
import eu.cloudscaleproject.env.csm.properties.components.RequiredInterfaceComposite;
	...
	public void refresh() {
		...
		if (pe != null) {
			...
			if(oic != null){
				...
				if (bo instanceof DeployableSoftwareService || bo instanceof UsageProxy)
				{

...
public class SpecificationEditor
	 ...
	 * @generated
	 */
	public static final List<String> FILE_EXTENSION_FILTERS = prefixExtensions(SpecificationModelWizard.FILE_EXTENSIONS, "*.");
		...
		if (!getEditingDomain().getResourceSet().getResources().isEmpty()) {
			...
			//
			{
				ViewerPane viewerPane =
					new ViewerPane(getSite().getPage(), SpecificationEditor.this) {
						@Override

...
/**
 * This is the item provider adapter for a {@link eu.cloudscaleproject.env.csm.architecture.CloudEnvironment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CloudEnvironmentItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addCloudProviderDescriptorPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Cloud Provider Descriptor feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addCloudProviderDescriptorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CloudEnvironment_cloudProviderDescriptor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CloudEnvironment_cloudProviderDescriptor_feature", "_UI_CloudEnvironment_type"),
				 ArchitecturePackage.Literals.CLOUD_ENVIRONMENT__CLOUD_PROVIDER_DESCRIPTOR,
				 true,
				 false,
				 true,
				 null,

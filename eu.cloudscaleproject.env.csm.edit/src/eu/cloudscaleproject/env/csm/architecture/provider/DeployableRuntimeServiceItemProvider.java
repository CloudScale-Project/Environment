...
/**
 * This is the item provider adapter for a {@link eu.cloudscaleproject.env.csm.architecture.DeployableRuntimeService} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeployableRuntimeServiceItemProvider
	 ...
	 * @generated
	 */
	public DeployableRuntimeServiceItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns DeployableRuntimeService.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DeployableRuntimeService"));
	}
	...
	public String getText(Object object) {
		String label = ((DeployableRuntimeService)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DeployableRuntimeService_type") :
			getString("_UI_DeployableRuntimeService_type") + " " + label;
	}

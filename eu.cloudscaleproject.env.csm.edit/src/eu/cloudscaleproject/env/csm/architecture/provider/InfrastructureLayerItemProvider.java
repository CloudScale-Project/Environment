...
/**
 * This is the item provider adapter for a {@link eu.cloudscaleproject.env.csm.architecture.InfrastructureLayer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InfrastructureLayer_services_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InfrastructureLayer_services_feature", "_UI_InfrastructureLayer_type"),
	...
	protected void addCloudProviderPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InfrastructureLayer_cloudProvider_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InfrastructureLayer_cloudProvider_feature", "_UI_InfrastructureLayer_type"),
				 ArchitecturePackage.Literals.INFRASTRUCTURE_LAYER__CLOUD_PROVIDER,
				 true,
				 false,
				 true,
				 null,

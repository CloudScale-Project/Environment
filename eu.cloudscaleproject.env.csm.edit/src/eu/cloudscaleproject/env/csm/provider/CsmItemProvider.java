/**
 */
package eu.cloudscaleproject.env.csm.provider;
...
/**
 * This is the item provider adapter for a {@link eu.cloudscaleproject.env.csm.Csm} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CsmItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CsmPackage.Literals.CSM__ARCHITECTURE);
			childrenFeatures.add(CsmPackage.Literals.CSM__DEFINITION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CsmPackage.Literals.CSM__ARCHITECTURE,
				 ArchitectureFactory.eINSTANCE.createArchitecture()));

		newChildDescriptors.add
			(createChildParameter
				(CsmPackage.Literals.CSM__DEFINITION,

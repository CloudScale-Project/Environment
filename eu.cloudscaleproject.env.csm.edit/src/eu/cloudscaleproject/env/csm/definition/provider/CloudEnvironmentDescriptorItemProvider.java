...
/**
 * This is the item provider adapter for a {@link eu.cloudscaleproject.env.csm.definition.CloudEnvironmentDescriptor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CloudEnvironmentDescriptorItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DefinitionPackage.Literals.CLOUD_ENVIRONMENT_DESCRIPTOR__AVAILABILITY_ZONES);
			childrenFeatures.add(DefinitionPackage.Literals.CLOUD_ENVIRONMENT_DESCRIPTOR__REGIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DefinitionPackage.Literals.CLOUD_ENVIRONMENT_DESCRIPTOR__AVAILABILITY_ZONES,
				 DefinitionFactory.eINSTANCE.createAvailabilityZoneDescriptor()));

		newChildDescriptors.add
			(createChildParameter
				(DefinitionPackage.Literals.CLOUD_ENVIRONMENT_DESCRIPTOR__REGIONS,

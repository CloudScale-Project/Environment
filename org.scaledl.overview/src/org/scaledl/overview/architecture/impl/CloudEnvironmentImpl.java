...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Cloud Environment</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.scaledl.overview.architecture.impl.CloudEnvironmentImpl#getArchitecture <em>Architecture</em>}</li>
 *   <li>{@link org.scaledl.overview.architecture.impl.CloudEnvironmentImpl#getInternalConnections <em>Internal Connections</em>}</li>
 *   <li>{@link org.scaledl.overview.architecture.impl.CloudEnvironmentImpl#getCloudEnvironmentDescriptor <em>Cloud Environment Descriptor</em>}</li>
 *   <li>{@link org.scaledl.overview.architecture.impl.CloudEnvironmentImpl#getAvailabilityZoneDescriptor <em>Availability Zone Descriptor</em>}</li>
 *   <li>{@link org.scaledl.overview.architecture.impl.CloudEnvironmentImpl#getInfrastructureLayer <em>Infrastructure Layer</em>}</li>
 *   <li>{@link org.scaledl.overview.architecture.impl.CloudEnvironmentImpl#getPlatformLayer <em>Platform Layer</em>}</li>
 *   <li>{@link org.scaledl.overview.architecture.impl.CloudEnvironmentImpl#getSoftwareLayer <em>Software Layer</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CloudEnvironmentImpl extends EntityImpl implements CloudEnvironment {
	/**
	...
	/**
	 * The cached value of the '{@link #getCloudEnvironmentDescriptor() <em>Cloud Environment Descriptor</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected CloudEnvironmentDescriptor cloudEnvironmentDescriptor;
	...
	public void setArchitecture(Architecture newArchitecture) {
		if (newArchitecture != eInternalContainer() || (eContainerFeatureID() != ArchitecturePackage.CLOUD_ENVIRONMENT__ARCHITECTURE && newArchitecture != null)) {
			...
			if (newArchitecture != null)
				msgs = ((InternalEObject)newArchitecture).eInverseAdd(this, ArchitecturePackage.ARCHITECTURE__CLOUD_ENVIRONMENTS, Architecture.class, msgs);
	 ...
	 * @generated
	 */
	public CloudEnvironmentDescriptor getCloudEnvironmentDescriptor() {
		if (cloudEnvironmentDescriptor != null && cloudEnvironmentDescriptor.eIsProxy()) {
			InternalEObject oldCloudEnvironmentDescriptor = (InternalEObject)cloudEnvironmentDescriptor;
			cloudEnvironmentDescriptor = (CloudEnvironmentDescriptor)eResolveProxy(oldCloudEnvironmentDescriptor);
			if (cloudEnvironmentDescriptor != oldCloudEnvironmentDescriptor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ArchitecturePackage.CLOUD_ENVIRONMENT__CLOUD_ENVIRONMENT_DESCRIPTOR, oldCloudEnvironmentDescriptor, cloudEnvironmentDescriptor));
			}
		}
	 ...
	 * @generated
	 */
	public CloudEnvironmentDescriptor basicGetCloudEnvironmentDescriptor() {
		return cloudEnvironmentDescriptor;
	}
	 ...
	 * @generated
	 */
	public void setCloudEnvironmentDescriptor(CloudEnvironmentDescriptor newCloudEnvironmentDescriptor) {
		CloudEnvironmentDescriptor oldCloudEnvironmentDescriptor = cloudEnvironmentDescriptor;
		cloudEnvironmentDescriptor = newCloudEnvironmentDescriptor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitecturePackage.CLOUD_ENVIRONMENT__CLOUD_ENVIRONMENT_DESCRIPTOR, oldCloudEnvironmentDescriptor, cloudEnvironmentDescriptor));
	}
	 ...
	 * @generated
	 */
	public void setAvailabilityZoneDescriptor(AvailabilityZoneDescriptor newAvailabilityZoneDescriptor) {
	...
	public void setInfrastructureLayer(InfrastructureLayer newInfrastructureLayer) {
		if (newInfrastructureLayer != infrastructureLayer) {
			...
			if (infrastructureLayer != null)
				msgs = ((InternalEObject)infrastructureLayer).eInverseRemove(this, ArchitecturePackage.INFRASTRUCTURE_LAYER__CLOUD_ENVIRONMENT, InfrastructureLayer.class, msgs);
			if (newInfrastructureLayer != null)
				msgs = ((InternalEObject)newInfrastructureLayer).eInverseAdd(this, ArchitecturePackage.INFRASTRUCTURE_LAYER__CLOUD_ENVIRONMENT, InfrastructureLayer.class, msgs);
	...
	public void setSoftwareLayer(SoftwareLayer newSoftwareLayer) {
		if (newSoftwareLayer != softwareLayer) {
			...
			if (softwareLayer != null)
				msgs = ((InternalEObject)softwareLayer).eInverseRemove(this, ArchitecturePackage.SOFTWARE_LAYER__CLOUD_ENVIRONMENT, SoftwareLayer.class, msgs);
			if (newSoftwareLayer != null)
				msgs = ((InternalEObject)newSoftwareLayer).eInverseAdd(this, ArchitecturePackage.SOFTWARE_LAYER__CLOUD_ENVIRONMENT, SoftwareLayer.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ArchitecturePackage.CLOUD_ENVIRONMENT__ARCHITECTURE:
				return eInternalContainer().eInverseRemove(this, ArchitecturePackage.ARCHITECTURE__CLOUD_ENVIRONMENTS, Architecture.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ArchitecturePackage.CLOUD_ENVIRONMENT__CLOUD_ENVIRONMENT_DESCRIPTOR:
				if (resolve) return getCloudEnvironmentDescriptor();
				return basicGetCloudEnvironmentDescriptor();
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ArchitecturePackage.CLOUD_ENVIRONMENT__INTERNAL_CONNECTIONS:
				...
				return;
			case ArchitecturePackage.CLOUD_ENVIRONMENT__CLOUD_ENVIRONMENT_DESCRIPTOR:
				setCloudEnvironmentDescriptor((CloudEnvironmentDescriptor)newValue);
				return;
			case ArchitecturePackage.CLOUD_ENVIRONMENT__AVAILABILITY_ZONE_DESCRIPTOR:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ArchitecturePackage.CLOUD_ENVIRONMENT__INTERNAL_CONNECTIONS:
				...
				return;
			case ArchitecturePackage.CLOUD_ENVIRONMENT__CLOUD_ENVIRONMENT_DESCRIPTOR:
				setCloudEnvironmentDescriptor((CloudEnvironmentDescriptor)null);
				return;
			case ArchitecturePackage.CLOUD_ENVIRONMENT__AVAILABILITY_ZONE_DESCRIPTOR:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case ArchitecturePackage.CLOUD_ENVIRONMENT__CLOUD_ENVIRONMENT_DESCRIPTOR:
				return cloudEnvironmentDescriptor != null;
			case ArchitecturePackage.CLOUD_ENVIRONMENT__AVAILABILITY_ZONE_DESCRIPTOR:

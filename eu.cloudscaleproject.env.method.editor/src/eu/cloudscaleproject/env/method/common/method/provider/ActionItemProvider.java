...
/**
 * This is the item provider adapter for a {@link eu.cloudscaleproject.env.method.common.method.Action} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionItemProvider extends StatusNodeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LinkedNode_next_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LinkedNode_next_feature", "_UI_LinkedNode_type"),
				 MethodPackage.Literals.LINKED_NODE__NEXT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPreviousPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LinkedNode_previous_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LinkedNode_previous_feature", "_UI_LinkedNode_type"),
				 MethodPackage.Literals.LINKED_NODE__PREVIOUS,
				 true,
				 false,
				 true,
				 null,

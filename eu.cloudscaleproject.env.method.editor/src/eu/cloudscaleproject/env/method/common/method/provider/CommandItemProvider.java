...
/**
 * This is the item provider adapter for a {@link eu.cloudscaleproject.env.method.common.method.Command} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommandItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Command_position_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Command_position_feature", "_UI_Command_type"),
				 MethodPackage.Literals.COMMAND__POSITION,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Command.class)) {
			case MethodPackage.COMMAND__POSITION:

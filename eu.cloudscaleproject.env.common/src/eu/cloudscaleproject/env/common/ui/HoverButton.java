...
public class HoverButton extends Composite{
	...
	public HoverButton(Composite parent, int style) {
		super(parent, style);
	...
	private class MouseHandler implements MouseTrackListener, MouseListener{
		...
		public void mouseUp(MouseEvent e) {
			for(SelectionListener l : selectionListeners){
				...
				Event ev = new Event();
				ev.widget = HoverButton.this;
				ev.item = HoverButton.this;
				ev.display = e.display;
				
				SelectionEvent se = new SelectionEvent(ev);
				se.display = e.display;
				se.doit = true;
				se.height = HoverButton.this.getSize().y;
				se.item = HoverButton.this;
				se.text = label.getText();
				se.widget = HoverButton.this;
				se.width = HoverButton.this.getSize().x;
				se.x = HoverButton.this.getLocation().x;
				se.y = HoverButton.this.getLocation().y;

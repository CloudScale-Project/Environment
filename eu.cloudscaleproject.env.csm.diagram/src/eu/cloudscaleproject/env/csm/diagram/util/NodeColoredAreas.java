...
public class NodeColoredAreas extends PredefinedColoredAreas {
	
	public static final String STYLE_ID = "cloudprovider-style";

	private static GradientColoredAreas getNodeDefaultAreas() {
	...
	private static GradientColoredAreas getNodePrimarySelectedAreas() {
		final GradientColoredAreas gradientColoredAreas = StylesFactory.eINSTANCE
				.createGradientColoredAreas();
		gradientColoredAreas
	...
	private static GradientColoredAreas getNodeSecondarySelectedAreas() {
		final GradientColoredAreas gradientColoredAreas = StylesFactory.eINSTANCE
				.createGradientColoredAreas();
		gradientColoredAreas
	...
	public static AdaptedGradientColoredAreas getNodeAdaptions() {

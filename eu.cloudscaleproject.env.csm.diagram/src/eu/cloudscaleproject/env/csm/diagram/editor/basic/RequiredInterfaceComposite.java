...
public class RequiredInterfaceComposite extends Composite {
	...
	protected DataBindingContext initDataBindings() {
		...
		//
		IObservableList applicationServiceRequiredInterfacesObserveList = EMFEditObservables.observeList(Realm.getDefault(), editingDomain, softwareService, ArchitecturePackage.Literals.OPERATION_INTERFACE_CONTAINER__REQUIRED_INTERFACES);

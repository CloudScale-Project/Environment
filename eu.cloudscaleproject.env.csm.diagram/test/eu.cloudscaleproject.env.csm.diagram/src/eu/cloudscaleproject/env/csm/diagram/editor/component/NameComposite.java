...
public class NameComposite extends Composite {
	...
	public NameComposite(Composite parent, Entity entity) {
		...
		txtDescription = new Text(this, SWT.MULTI);
	...
	protected DataBindingContext initDataBindings() {
		...
		IObservableValue entityDescriptionObserveValue = EMFEditObservables.observeValue(editingDomain, entity, Literals.ENTITY__DESCRIPTION);
		...
		IObservableValue entityNameObserveValue = EMFEditObservables.observeValue(editingDomain, entity, Literals.ENTITY__NAME);

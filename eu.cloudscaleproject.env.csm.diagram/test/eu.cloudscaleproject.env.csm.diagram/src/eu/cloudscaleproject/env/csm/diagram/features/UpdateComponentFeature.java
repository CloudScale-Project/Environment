...
public class UpdateComponentFeature extends AbstractUpdateFeature {

	public UpdateComponentFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canUpdate(IUpdateContext context) {
		...
		return (bo instanceof PlatformService);
	}
	...
	public IReason updateNeeded(IUpdateContext context) {
		...
		if (bo instanceof PlatformService) {
			PlatformService component = (PlatformService) bo;

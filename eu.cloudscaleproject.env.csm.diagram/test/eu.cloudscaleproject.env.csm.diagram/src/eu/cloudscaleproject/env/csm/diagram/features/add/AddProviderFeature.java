...
public class AddProviderFeature extends AbstractAddFeature implements IAddFeature {
	...
	public AddProviderFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public PictogramElement add(IAddContext context) {
		...
		CloudProvider provider = (CloudProvider)context.getNewObject();

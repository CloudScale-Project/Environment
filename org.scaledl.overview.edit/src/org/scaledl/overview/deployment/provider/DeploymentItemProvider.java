...
/**
 * This is the item provider adapter for a {@link org.scaledl.overview.deployment.Deployment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeploymentItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DeploymentPackage.Literals.DEPLOYMENT__SERVICE_DEPLOYMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DeploymentPackage.Literals.DEPLOYMENT__SERVICE_DEPLOYMENTS,
				 DeploymentFactory.eINSTANCE.createServiceDeployment()));

		newChildDescriptors.add
			(createChildParameter
				(DeploymentPackage.Literals.DEPLOYMENT__SERVICE_DEPLOYMENTS,
				 DeploymentFactory.eINSTANCE.createGenericDeployment()));

		newChildDescriptors.add
			(createChildParameter
				(DeploymentPackage.Literals.DEPLOYMENT__SERVICE_DEPLOYMENTS,
				 DeploymentFactory.eINSTANCE.createRuntimeDeployment()));
	}

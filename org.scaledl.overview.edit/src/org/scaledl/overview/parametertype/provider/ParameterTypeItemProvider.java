...
/**
 * This is the item provider adapter for a {@link org.scaledl.overview.parametertype.ParameterType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParameterTypeItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ParametertypePackage.Literals.PARAMETER_TYPE__TYPES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ParameterType.class)) {
			case ParametertypePackage.PARAMETER_TYPE__TYPES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ParametertypePackage.Literals.PARAMETER_TYPE__TYPES,
				 ParametertypeFactory.eINSTANCE.createParameter()));

		newChildDescriptors.add
			(createChildParameter
				(ParametertypePackage.Literals.PARAMETER_TYPE__TYPES,
				 ParametertypeFactory.eINSTANCE.createPrimitiveParameter()));

		newChildDescriptors.add
			(createChildParameter
				(ParametertypePackage.Literals.PARAMETER_TYPE__TYPES,
				 ParametertypeFactory.eINSTANCE.createCompositeParameter()));

		newChildDescriptors.add
			(createChildParameter
				(ParametertypePackage.Literals.PARAMETER_TYPE__TYPES,
				 ParametertypeFactory.eINSTANCE.createCollectionParameter()));
	}

...
public class DeploymentComposite extends Composite {
	...
	private PlatformService dpService;
	 ...
	 * @param style
	 */
	public DeploymentComposite(Composite parent, PlatformService dpService, CloudSpecification cloudSpecification) {
		...
		btnNewButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				Overview overview = (Overview)EcoreUtil.getRootContainer(DeploymentComposite.this.dpService);
				SystemEditorInput input = new SystemEditorInput(overview);
	...
	private void initInstance ()
	{
		...
		{
			ComputingResourceDescriptor compResourceDesc = dpService.getComputingInfrastructureService().getDescriptor().getComputingResourceDescriptors().get(0);
			
			txtCpu.setText(compResourceDesc.getCpu()+"");
			txtCpuUnits.setText(compResourceDesc.getCpuUnits()+"");
			txtMemory.setText(compResourceDesc.getMemory()+"");
			txtStorage.setText(compResourceDesc.getStorage()+"");
		}
		else
		{
			txtCpu.setText("");

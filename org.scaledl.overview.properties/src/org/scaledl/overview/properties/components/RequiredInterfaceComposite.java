...
import org.scaledl.overview.properties.components.dialogs.DialogResolveInterface;
import org.scaledl.overview.properties.components.dialogs.DialogSelectInterface;
...
public class RequiredInterfaceComposite extends Composite {
	...
	public RequiredInterfaceComposite(Composite parent) {
		...
		fd_btnAdd.right = new FormAttachment(table, 45, SWT.RIGHT);
	...
	protected DataBindingContext initDataBindings() {
		...
		IObservableMap[] observeMaps = EMFEditObservables.observeMaps(editingDomain, listContentProvider.getKnownElements(), 
				new EStructuralFeature[]{CorePackage.Literals.ENTITY__NAME, ApplicationPackage.Literals.OPERATION_INTERFACE__PROVIDING_CONTAINER});
		...
		//
		IObservableList applicationServiceRequiredInterfacesObserveList = EMFEditObservables.observeList(Realm.getDefault(), editingDomain, opInterfaceContainer, ApplicationPackage.Literals.OPERATION_INTERFACE_CONTAINER__REQUIRED_INTERFACES);

...
/**
 * This is the item provider adapter for a {@link org.scaledl.overview.parametertype.PrimitiveParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PrimitiveParameterItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PrimitiveParameter_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PrimitiveParameter_type_feature", "_UI_PrimitiveParameter_type"),
				 ParametertypePackage.Literals.PRIMITIVE_PARAMETER__TYPE,
				 true,
				 false,
				 false,

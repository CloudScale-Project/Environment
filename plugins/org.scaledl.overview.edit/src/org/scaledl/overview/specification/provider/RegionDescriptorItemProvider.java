...
/**
 * This is the item provider adapter for a {@link org.scaledl.overview.specification.RegionDescriptor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RegionDescriptorItemProvider
	 ...
	 * @generated
	 */
	public RegionDescriptorItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns RegionDescriptor.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RegionDescriptor"));
	}
	...
	public String getText(Object object) {
		String label = ((RegionDescriptor)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_RegionDescriptor_type") :
			getString("_UI_RegionDescriptor_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RegionDescriptor.class)) {
			case SpecificationPackage.REGION_DESCRIPTOR__PROVIDER_ID:

...
/**
 * This is the item provider adapter for a {@link org.scaledl.overview.architecture.ExternalConnection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExternalConnection_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExternalConnection_source_feature", "_UI_ExternalConnection_type"),
				 ArchitecturePackage.Literals.EXTERNAL_CONNECTION__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExternalConnection_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExternalConnection_target_feature", "_UI_ExternalConnection_type"),
				 ArchitecturePackage.Literals.EXTERNAL_CONNECTION__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addBandwidthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExternalConnection_bandwidth_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExternalConnection_bandwidth_feature", "_UI_ExternalConnection_type"),
				 ArchitecturePackage.Literals.EXTERNAL_CONNECTION__BANDWIDTH,
				 true,
				 false,
				 false,
	...
	protected void addLatencyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExternalConnection_latency_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExternalConnection_latency_feature", "_UI_ExternalConnection_type"),
				 ArchitecturePackage.Literals.EXTERNAL_CONNECTION__LATENCY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,

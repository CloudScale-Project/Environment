...
/**
 * This is the item provider adapter for a {@link eu.cloudscaleproject.env.method.common.method.Warning} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WarningItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Warning_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Warning_id_feature", "_UI_Warning_type"),
				 MethodPackage.Literals.WARNING__ID,
				 true,
				 false,
				 false,
	...
	protected void addMessagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Warning_message_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Warning_message_feature", "_UI_Warning_type"),
				 MethodPackage.Literals.WARNING__MESSAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MethodPackage.Literals.WARNING__COMMANDS);
		}
	...
	public String getText(Object object) {
		String label = ((Warning)object).getId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MethodPackage.Literals.WARNING__COMMANDS,

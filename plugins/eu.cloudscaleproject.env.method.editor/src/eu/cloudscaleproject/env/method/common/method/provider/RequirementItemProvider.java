...
/**
 * This is the item provider adapter for a {@link eu.cloudscaleproject.env.method.common.method.Requirement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RequirementItemProvider 
	extends StatusNodeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Requirement_position_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Requirement_position_feature", "_UI_Requirement_type"),
				 MethodPackage.Literals.REQUIREMENT__POSITION,
				 true,
				 false,
				 false,

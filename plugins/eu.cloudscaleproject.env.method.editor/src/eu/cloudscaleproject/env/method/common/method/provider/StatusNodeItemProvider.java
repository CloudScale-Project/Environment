...
/**
 * This is the item provider adapter for a {@link eu.cloudscaleproject.env.method.common.method.StatusNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StatusNodeItemProvider 
	 ...
	 * @generated
	 */
	public StatusNodeItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addDirtyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StatusNode_dirty_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StatusNode_dirty_feature", "_UI_StatusNode_type"),
				 MethodPackage.Literals.STATUS_NODE__DIRTY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MethodPackage.Literals.STATUS_NODE__WARNINGS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StatusNode"));
	}
	...
	public String getText(Object object) {
		String label = ((StatusNode)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_StatusNode_type") :
			getString("_UI_StatusNode_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MethodPackage.Literals.STATUS_NODE__WARNINGS,
				 MethodFactory.eINSTANCE.createWarning()));
	}

...
public class OpenPerspectiveHandler {
	...
	private final Logger logger = Logger.getLogger(OpenPerspectiveHandler.class.getName());
	...
	public void execute(@Named("PerspectiveId") String perspectiveId, 
		...
		if (element != null) {
			...
			logger.warning("Perspective with perspectiveId: " + perspectiveId + " does not exist!");
		}

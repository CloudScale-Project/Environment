/**
 */
package org.scaledl.overview.presentation;
...
import org.scaledl.overview.application.presentation.ApplicationEditor;

import org.scaledl.overview.architecture.presentation.ArchitectureEditor;

import org.scaledl.overview.core.presentation.CoreEditor;

import org.scaledl.overview.deployment.presentation.DeploymentEditor;

import org.scaledl.overview.parametertype.presentation.ParametertypeEditor;

import org.scaledl.overview.specification.presentation.SpecificationEditor;

import org.scaledl.overview.specification.sla.presentation.SlaEditor;
 ...
 * @generated
 */
public final class OverviewEditorAdvisor extends WorkbenchAdvisor {
	/**
	...
	private static String[] getFileExtensionFilters() {
		...
		result.addAll(OverviewEditor.FILE_EXTENSION_FILTERS);
		result.addAll(CoreEditor.FILE_EXTENSION_FILTERS);
		result.addAll(ApplicationEditor.FILE_EXTENSION_FILTERS);
		result.addAll(ArchitectureEditor.FILE_EXTENSION_FILTERS);
		result.addAll(DeploymentEditor.FILE_EXTENSION_FILTERS);
		result.addAll(SpecificationEditor.FILE_EXTENSION_FILTERS);
		result.addAll(SlaEditor.FILE_EXTENSION_FILTERS);
		result.addAll(ParametertypeEditor.FILE_EXTENSION_FILTERS);
	...
	private static String getString(String key, Object s1) {
		return org.scaledl.overview.presentation.OverviewEditorPlugin.INSTANCE.getString(key, new Object [] { s1 });
	}
	...
	public static class Perspective implements IPerspectiveFactory {
		 ...
		 * @generated
		 */
		public static final String ID_PERSPECTIVE = "org.scaledl.overview.presentation.OverviewEditorAdvisorPerspective";
	...
	/**
	 * Open action for the objects from the Overview model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Open URI action for the objects from the Overview model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */

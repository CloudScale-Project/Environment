 ...
 * @generated
 */
public class ParametertypeSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ParametertypePackage.PARAMETER_TYPE: {
				ParameterType parameterType = (ParameterType)theEObject;
				T result = caseParameterType(parameterType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParametertypePackage.PARAMETER: {
			...
			case ParametertypePackage.PRIMITIVE_PARAMETER: {
				...
				if (result == null) result = caseEntity(primitiveParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParametertypePackage.COMPOSITE_PARAMETER: {
				...
				if (result == null) result = caseEntity(compositeParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParametertypePackage.COLLECTION_PARAMETER: {
				...
				if (result == null) result = caseEntity(collectionParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}

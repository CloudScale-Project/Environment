...
public class SlaSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SlaPackage.PRICE_MODEL: {
				PriceModel priceModel = (PriceModel)theEObject;
				T result = casePriceModel(priceModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SlaPackage.SLO: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Price Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Price Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePriceModel(PriceModel object) {
		return null;
	}

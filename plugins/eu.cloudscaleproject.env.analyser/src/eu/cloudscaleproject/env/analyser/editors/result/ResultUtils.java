...
public class ResultUtils
{
	...
	public enum ChartType {
		// Extensions : org.palladiosimulator.edp2.visualization.jfreechart
		XY("org.palladiosimulator.edp2.visualization.jfreechart.xyplot"), 
		HISTOGRAM("org.palladiosimulator.edp2.visualization.jfreechart.histogram"), 
		PIE("org.palladiosimulator.edp2.visualization.jfreechart.piechart");
	...
	public static ChainDescription getChainDescriptionByChartType(ChartType type)
	{
		List<ChainDescription> descriptions = getApplicableChainDescriptionsFromExtensions();

		for (ChainDescription chainDescription : descriptions)
		{
			if (type.ID.equals(chainDescription.getChainID()))
			{
	...
	public static List<ChainDescription> getApplicableChainDescriptionsFromExtensions()
	{
		...
		IConfigurationElement[] chainDescriptionExtensions = Platform.getExtensionRegistry().getConfigurationElementsFor(
	...
	private static IPropertyConfigurable createAndConfigureChainElement(final Map<String, AbstractVisualizationInput<?>> charts,
	...
	private static IPropertyConfigurable createChainElement(final Map<String, AbstractVisualizationInput<?>> charts,
			final IConfigurationElement element)
	{
		try
		{

 ...
 *
 */
public class MonitorResultsCompositeNew extends Composite implements IRefreshable{
	...
	public MonitorResultsCompositeNew(ResultAlternative alternative, Composite parent, int style) {
		super(parent, style);

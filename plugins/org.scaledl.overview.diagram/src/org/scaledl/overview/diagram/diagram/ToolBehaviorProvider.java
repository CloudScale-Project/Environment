...
import org.scaledl.overview.diagram.DiagramImageProvider;
...
import org.scaledl.overview.diagram.features.create.CreatePlatformServiceFeature;
...
public class ToolBehaviorProvider extends DefaultToolBehaviorProvider {
	...
	public IPaletteCompartmentEntry[] getPalette() {
		...
		List <CreatePlatformServiceFeature> platformFeatures = getCreateFeatures(CreatePlatformServiceFeature.class);
		List <CreateProvidedSoftwareServiceFeature> softwareFeatures = getCreateFeatures(CreateProvidedSoftwareServiceFeature.class);
		...
		for (CreateCloudEnvironmentFeature cloudFeature : cloudProviderFeatures) {
			...
			CloudEnvironmentDescriptor descriptor = cloudFeature.getCloudSpecification().getDescriptor();
			...
			// Add all related platform components in this compartment
			for (CreatePlatformServiceFeature componentFeature : platformFeatures) {
			...
			for (CreateProvidedSoftwareServiceFeature componentFeature : softwareFeatures) {

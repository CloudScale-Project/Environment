...
public class WarningImpl extends MinimalEObjectImpl.Container implements Warning {
	...
	protected EClass eStaticClass() {
		return MethodPackage.Literals.WARNING;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MethodPackage.WARNING__ID, oldId, id));
	}
	...
	public void setMessage(String newMessage) {
		...
		message = newMessage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MethodPackage.WARNING__MESSAGE, oldMessage, message));
	}
	...
	public EList<Command> getCommands() {
		if (commands == null) {
			commands = new EObjectContainmentEList<Command>(Command.class, this, MethodPackage.WARNING__COMMANDS);
		}
		return commands;
	}

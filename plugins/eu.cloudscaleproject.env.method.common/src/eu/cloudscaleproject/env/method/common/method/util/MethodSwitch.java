...
public class MethodSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MethodPackage.STATUS_NODE: {
			...
			case MethodPackage.REQUIREMENT: {
				Requirement requirement = (Requirement)theEObject;
				T result = caseRequirement(requirement);
				if (result == null) result = caseStatusNode(requirement);
				if (result == null) result = caseNode(requirement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MethodPackage.WARNING: {
				Warning warning = (Warning)theEObject;
				T result = caseWarning(warning);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MethodPackage.COMMAND: {
				Command command = (Command)theEObject;
				T result = caseCommand(command);
				if (result == null) result = caseNode(command);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}

...
public class CoreAdapterFactory extends AdapterFactoryImpl {
	...
	protected CoreSwitch<Adapter> modelSwitch = new CoreSwitch<Adapter>() {
			@Override
			public Adapter caseAVEntry(Map.Entry<String, Object> object) {
				return createAVEntryAdapter();
			}
			@Override
			public Adapter caseAEEntry(Map.Entry<String, EObject> object) {
				return createAEEntryAdapter();
			}
			@Override
	 ...
	 * <em>AE Entry</em>}'. <!-- begin-user-doc --> This default implementation
	 ...
	 * @generated
	 */
	public Adapter createAEEntryAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link java.util.Map.Entry
	 * <em>AV Entry</em>}'. <!-- begin-user-doc --> This default implementation
	 * returns null so that we can easily ignore cases; it's useful to ignore a
	 * case when inheritance will catch all the cases anyway. <!-- end-user-doc
	 * -->
	 * 
	 ...
	 * @generated
	 */
	public Adapter createAVEntryAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link eu.cloudscaleproject.env.csm.core.Operation <em>Operation</em>}'.
	...
	/**
	 * Creates a new adapter for an object of class '{@link eu.cloudscaleproject.env.csm.core.OperationInterface <em>Operation Interface</em>}'.

 ...
 * <em><b>Usage Proxy</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link eu.cloudscaleproject.env.csm.architecture.impl.UsageProxyImpl#getProvidedInterfaces <em>Provided Interfaces</em>}</li>
 *   <li>{@link eu.cloudscaleproject.env.csm.architecture.impl.UsageProxyImpl#getRequiredInterfaces <em>Required Interfaces</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UsageProxyImpl extends ProxyImpl implements UsageProxy {
	...
	public EList<OperationInterface> getProvidedInterfaces() {
		if (providedInterfaces == null) {
			providedInterfaces = new EObjectContainmentWithInverseEList<OperationInterface>(OperationInterface.class, this, ArchitecturePackage.USAGE_PROXY__PROVIDED_INTERFACES, CorePackage.OPERATION_INTERFACE__PROVIDING_CONTAINER);
		}
	...
	public EList<OperationInterface> getRequiredInterfaces() {
		if (requiredInterfaces == null) {
			requiredInterfaces = new EObjectWithInverseResolvingEList.ManyInverse<OperationInterface>(OperationInterface.class, this, ArchitecturePackage.USAGE_PROXY__REQUIRED_INTERFACES, CorePackage.OPERATION_INTERFACE__REQUIRING_CONTAINER);
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == OperationInterfaceContainer.class) {
			switch (derivedFeatureID) {
				case ArchitecturePackage.USAGE_PROXY__PROVIDED_INTERFACES: return ArchitecturePackage.OPERATION_INTERFACE_CONTAINER__PROVIDED_INTERFACES;
				case ArchitecturePackage.USAGE_PROXY__REQUIRED_INTERFACES: return ArchitecturePackage.OPERATION_INTERFACE_CONTAINER__REQUIRED_INTERFACES;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == OperationInterfaceContainer.class) {
			switch (baseFeatureID) {
				case ArchitecturePackage.OPERATION_INTERFACE_CONTAINER__PROVIDED_INTERFACES: return ArchitecturePackage.USAGE_PROXY__PROVIDED_INTERFACES;
				case ArchitecturePackage.OPERATION_INTERFACE_CONTAINER__REQUIRED_INTERFACES: return ArchitecturePackage.USAGE_PROXY__REQUIRED_INTERFACES;
				default: return -1;
			}
		}

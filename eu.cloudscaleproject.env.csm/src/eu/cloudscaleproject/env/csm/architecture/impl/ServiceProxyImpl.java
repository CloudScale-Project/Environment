 ...
 * <ul>
 *   <li>{@link eu.cloudscaleproject.env.csm.architecture.impl.ServiceProxyImpl#getSoftwareService <em>Software Service</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServiceProxyImpl extends ProxyImpl implements ServiceProxy {
	 ...
	 * @ordered
	 */
	protected ExternalSoftwareService softwareService;
	 ...
	 * @generated
	 */
	public ExternalSoftwareService getSoftwareService() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSoftwareService(ExternalSoftwareService newSoftwareService, NotificationChain msgs) {
		ExternalSoftwareService oldSoftwareService = softwareService;
	 ...
	 * @generated
	 */
	public void setSoftwareService(ExternalSoftwareService newSoftwareService) {
		if (newSoftwareService != softwareService) {
			NotificationChain msgs = null;
			if (softwareService != null)
				msgs = ((InternalEObject)softwareService).eInverseRemove(this, ArchitecturePackage.EXTERNAL_SOFTWARE_SERVICE__SERVICE_PROXY, ExternalSoftwareService.class, msgs);
			if (newSoftwareService != null)
				msgs = ((InternalEObject)newSoftwareService).eInverseAdd(this, ArchitecturePackage.EXTERNAL_SOFTWARE_SERVICE__SERVICE_PROXY, ExternalSoftwareService.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ArchitecturePackage.SERVICE_PROXY__SOFTWARE_SERVICE:
				...
				return basicSetSoftwareService((ExternalSoftwareService)otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ArchitecturePackage.SERVICE_PROXY__SOFTWARE_SERVICE:
				setSoftwareService((ExternalSoftwareService)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ArchitecturePackage.SERVICE_PROXY__SOFTWARE_SERVICE:
				setSoftwareService((ExternalSoftwareService)null);
				return;
		}
